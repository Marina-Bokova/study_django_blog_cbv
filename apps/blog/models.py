...
class Post(models.Model):
    ...
    thumbnail = models.ImageField(default='images/thumbnails/default_thumbnail.jpg',
    ...
    update = models.DateTimeField(auto_now=True, verbose_name='Последнее изменение')
    ...
    def save(self, *args, **kwargs):
        """
        Генерация уникального slug при сохранении
        """
        print("called save")
...
class Category(MPTTModel):
    ...
    def get_absolute_url(self):
        """
        Получение прямой ссылки на категорию
        """
